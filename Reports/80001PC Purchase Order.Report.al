report 80001 "PC Purchase Order"
{
    DefaultLayout = RDLC;
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem(RoundLoop;"Integer")
                    {
                       ...
                       // {
                       // }
                        column(PurchLineItemRef;"Purchase Line"."Vendor Item No.")
                        {
                        }
                        ...
                        trigger OnAfterGetRecord()begin
                            ...
                            if(PurchLine.Type = PurchLine.Type::Item)then begin
                                if "Purchase Line"."No." <> '' then begin
                                    ...
                                    if ItemVendor.get("Purchase Line"."Buy-from Vendor No.", "Purchase Line"."No.", "Purchase Line"."Variant Code")then if ItemVendor."Vendor Item No." <> '' then "Purchase Line"."Vendor Item No.":=ItemVendor."Vendor Item No.";
                                    if("Purchase Line"."Vendor Item No." = '') and (item."Vendor No." = "Purchase Line"."Buy-from Vendor No.")then "Purchase Line"."Vendor Item No.":=item."Vendor Item No.";
                                end;
                            end;
