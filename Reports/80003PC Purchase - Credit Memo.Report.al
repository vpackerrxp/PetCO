report 80003 "PC Purchase - Credit Memo"
{
    DefaultLayout = RDLC;
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Purch. Cr. Memo Line";"Purch. Cr. Memo Line")
                    {
                        ...
                        column(PurchLineItemRef;"Vendor Item No.")
                        {
                        }
    ...
    local procedure FormatDocumentFields(PurchCrMemoHdr: Record "Purch. Cr. Memo Hdr.")begin
